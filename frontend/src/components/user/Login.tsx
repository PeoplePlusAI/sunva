        ...
        >
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-[400px]">
                <div className="w-full text-center flex items-center justify-center mb-7">
                    <img src="/logo.png" className="h-[80px]" alt="Sunva Logo - People+ai; An EkStep initiative" draggable={false}/>
                </div>
                <div className="unit mb-4">
                    <label htmlFor="email" className="text-gray-500">Email</label>
                    <input type="email" name="email" placeholder="hello@demo.com" className="border-[2px] rounded-lg w-full"
